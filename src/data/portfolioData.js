...
export const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      { name: "React.js", level: "Intermediate", percentage: 75, icon: "react" },
      { name: "Node.js & Express", level: "Intermediate", percentage: 75, icon: "node" },
      { name: "REST APIs", level: "Intermediate", percentage: 75, icon: "api" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Data Structures & Algorithms", level: "Intermediate", percentage: 75, icon: "dsa" },
