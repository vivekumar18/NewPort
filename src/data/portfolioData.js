...
export const skillCategories = [
  {
    ...
    skills: [
      { name: "Java", level: "Proficient", percentage: 90, icon: "java" },
      { name: "JavaScript (ES6+)", level: "Proficient", percentage: 88, icon: "js" },
      { name: "C / C++", level: "Intermediate", percentage: 75, icon: "cpp" },
      { name: "Python", level: "Proficient", percentage: 82, icon: "python" },
    ],
  },
  {
    id: "web",
    ...
    skills: [
      { name: "React.js", level: "Proficient", percentage: 88, icon: "react" },
      { name: "Node.js & Express", level: "Intermediate", percentage: 75, icon: "node" },
      { name: "REST APIs", level: "Proficient", percentage: 85, icon: "api" },
      { name: "HTML5 & CSS3", level: "Proficient", percentage: 92, icon: "html" },
      { name: "AWS Cloud", level: "Working Knowledge", percentage: 60, icon: "aws" },
    ],
  },
  {
    id: "databases",
    ...
    skills: [
      { name: "MySQL", level: "Proficient", percentage: 88, icon: "mysql" },
      { name: "MongoDB", level: "Intermediate", percentage: 72, icon: "mongodb" },
      { name: "Oracle DB", level: "Working Knowledge", percentage: 58, icon: "oracle" },
      { name: "Data Structures & Algorithms", level: "Proficient", percentage: 85, icon: "dsa" },
      { name: "DBMS & Operating Systems", level: "Proficient", percentage: 88, icon: "cs" },
    ],
  },
  {
    id: "tools",
    ...
    skills: [
      { name: "Git & GitHub", level: "Proficient", percentage: 90, icon: "git" },
      { name: "VS Code", level: "Proficient", percentage: 92, icon: "vscode" },
      { name: "Jira & SolarWinds", level: "Working Knowledge", percentage: 55, icon: "jira" },
      { name: "Agile & SDLC Practices", level: "Intermediate", percentage: 75, icon: "agile" },
    ],
  },
];
...
export const certifications = [
  ...
  },
  {
    ...
    icon: "award",
    link: "https://www.linkedin.com/posts/vivek-kumar-3579841a7_isp-internshala-graphicerauniversity-activity-7352556970530254850-QRCb?utm_source=share&utm_medium=member_desktop&rcm=ACoAADBgQPMBw24NXc4FGpzWItvNBaoM3-x2GDs",
    verifyUrl: "https://www.linkedin.com/posts/vivek-kumar-3579841a7_isp-internshala-graphicerauniversity-activity-7352556970530254850-QRCb?utm_source=share&utm_medium=member_desktop&rcm=ACoAADBgQPMBw24NXc4FGpzWItvNBaoM3-x2GDs",
  ...
  },
  {
    ...
    icon: "aws",
    link: "https://www.linkedin.com/posts/vivek-kumar-3579841a7_aws-artificialintelligence-cloudcomputing-activity-7381015475155247104-09ql?utm_source=share&utm_medium=member_desktop&rcm=ACoAADBgQPMBw24NXc4FGpzWItvNBaoM3-x2GDs",
    verifyUrl: "https://www.linkedin.com/posts/vivek-kumar-3579841a7_aws-artificialintelligence-cloudcomputing-activity-7381015475155247104-09ql?utm_source=share&utm_medium=member_desktop&rcm=ACoAADBgQPMBw24NXc4FGpzWItvNBaoM3-x2GDs",
